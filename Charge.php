...
class Charge
{
	...
	public function isRedactable()
	{
		...
		$nonRedactableDisps = array("Guilty" , "Guilty Plea", "Guilty Plea - Negotiated", "Guilty Plea - Non-Negotiated", "Held for Court", "Waived for Court", "Held for Court (Lower Court)", "Nolo Contendere");
